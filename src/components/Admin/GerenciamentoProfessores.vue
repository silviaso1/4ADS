<template>
  <div class="gerenciamento">
    <div class="gerenciamento__cabecalho">
      ...
      <button class="botao-primario" @click="$emit('abrir-modal-professor', null)">
    ...
    <div class="tabela-wrapper">
          ...
          <tr v-for="professor in professoresFiltrados" :key="professor.id">
            ...
            <td class="coluna-acoes">
              <button 
                ...
                @click="$emit('abrir-modal-professor', professor)"
              ...
              <button 
                ...
                @click="$emit('confirmar-exclusao', 'professor', professor.id)"
      ...
      <div v-if="professores.length === 0" class="sem-resultados">
        <i class="fas fa-user-tie icone-vazio"></i>
        <p>Nenhum professor cadastrado</p>
      </div>
      <div v-else-if="professoresFiltrados.length === 0" class="sem-resultados">
